			...
			<div class="container">
				<div class="alignR">
					...
					<a href="index.htm"> <span class="icon-home"></span> Home
						...
						class="active" href="register.htm"><span class="icon-edit"></span>
						Free Register </a> <a href="contact.htm"><span
						class="icon-envelope"></span> Contact us</a> <a href="cart.htm"><span
