...
<head>
<meta charset="UTF-8">
<title>Danh sách đơn đặt hàng đã duyệt</title>
	...
	<div class="content-wrapper">
		<section class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<a href="/admin/management/staff/list"><h1>Danh sách đơn đặt hàng đã duyệt</h1></a>
					</div>
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							<li class="breadcrumb-item"><a href="/admin/home">Home</a></li>
							<li class="breadcrumb-item active">Danh sách đơn đặt hàng đã duyệt</li>
						</ol>
					</div>
		...
		<section class="content">
			<form action="<c:url value='/admin/management/order/list/approved'/>" id="formSubmit"
				method="get">
				<div class="container-fluid">
